...
('HL-05-MED',      'supra', 5,  'General Medicine Dept',    'medicine',    '{"HL-03-CLIN"}',                1),
...
('N-O11', 'supra', 'HL-05-ORTHO', 'DECISION', 'Ortho Department Budget Allocation 2026',
 'FY 2026 budget: Rs 4.2 Cr. Implants: 45%, Staffing: 30%, Equipment: 15%, Training: 10%. New arthroscopy equipment approved Q3. Budget review: Dr. Vikram quarterly.',
...
('N-A01', 'supra', 'HL-01', 'DECISION', 'Hospital Expansion Plan 2026-2028',
 'Board-approved: 80 additional beds by Q4 2027. New Oncology wing (40 beds), ICU expansion (20 beds), Ortho upgrade (20 beds). Total investment: Rs 85 Cr. Contractor: L&T. STRICTLY CONFIDENTIAL.',
