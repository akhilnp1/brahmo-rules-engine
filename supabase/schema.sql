...
CREATE INDEX IF NOT EXISTS idx_nodes_zone ON knowledge_nodes(zone);
...
CREATE INDEX IF NOT EXISTS idx_nodes_hierarchy ON knowledge_nodes(hierarchy_level_id);
CREATE INDEX IF NOT EXISTS idx_nodes_compliance ON knowledge_nodes USING GIN(compliance_tags);
CREATE INDEX IF NOT EXISTS idx_edges_source ON edges(source_id);
CREATE INDEX IF NOT EXISTS idx_edges_target ON edges(target_id);
CREATE INDEX IF NOT EXISTS idx_hierarchy_org ON hierarchy_levels(org_id);
CREATE INDEX IF NOT EXISTS idx_hierarchy_parent ON hierarchy_levels USING GIN(parent_ids);
